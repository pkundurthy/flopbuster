...
def getFeatureSet():
    """ TO DO give options to select only subsets of the feautre set  """

    cursor = dbConnect()
    statement1 = 'select distinct(part) from movie_meta order by partType;'
...
class person:
    ...
    def _get_history(self):
        ...
        self.Year_of_LastRelease = max_date
